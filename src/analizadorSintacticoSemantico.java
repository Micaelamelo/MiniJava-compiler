...
public class analizadorSintacticoSemantico {
	...
	public analizadorSintacticoSemantico(String archivo) throws Exception{
	...
	private String match(String nombre) throws Exception{
	...
	//	System.out.println("tipo es "+t.getTipo());
		...
		ListaDecVars(v,t); 	// lista dec atributos, y lo q hice todo ahora pasarlo a lista dec atributos; y listadec
		match("Punto y coma");
	}
	...
	private void ListaDecVars(String v, Tipo t) throws Exception{
		tabla.getClaseActual().insertarAtributo(new Atributo(tokenActual.getLexema(), t, v, tokenActual.getNroLinea()));
		match("Id Metodo-Variable");
		LDV(v,t);
		
	}
	
	private void LDV(String v, Tipo t) throws Exception{
		if (tokenActual.getNombre().equals("Coma")) {
			match("Coma");
			ListaDecVars(v,t);
		}
