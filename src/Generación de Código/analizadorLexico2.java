...
public class analizadorLexico2 {
	 ...
	 */
	public analizadorLexico2(String archivo){
			...
			switch(estado){
				case 0:
					...
					if(esEspacio(caracterActual)){
						...
						if (caracterActual == '\''){
							...
							if(finArchivo)
								throw new Exception("Caracter literal mal formado, se encontro solo una comilla simple en la linea "+nroLinea);
					}
						...
						if (caracterActual == '"'){
							...
							if(finArchivo)
								throw new Exception("String mal formado, se encontro solo una comilla doble en linea "+ nroLinea);
					}
						...
						if (caracterActual == '&'){
							...
							if(finArchivo)
								throw new Exception("Operador mal formado en linea "+ nroLinea);
					}
				...
				case 4: 
					...
					if (caracterActual == '/') {
						...
						consumir();
						if(finArchivo)
							throw new Exception("Comentario mal formado en la linea "+nroLinea);
					}
					else 
				...
				case 5:
					...
					if(finArchivo)
						throw new Exception("Caracter mal formado en liena "+nroLinea);
